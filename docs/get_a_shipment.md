...
paths:
  /shipments/{id}:
    ...
    get:
      ...
      description: >-
        Retrieves the details of an existing shipment. You need only supply the
        unique shipment `id` that was returned upon `tracking_request` creation.
              ...
              examples:
                En-route to NY with inland move:
                  value:
                    ...
                    links:
                      self: >-
                        https://api.terminal49.com/v2/shipments/02b1bd6f-407c-45bb-8645-06e7ee34e7e3?include=containers
                    included:
                      - id: 55a700e4-7005-45a9-92fd-1ff38641dbd9
                        type: container
                        attributes:
