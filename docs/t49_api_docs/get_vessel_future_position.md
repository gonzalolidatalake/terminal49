...
````yaml get /vessels/{id}/future_positions
openapi: 3.0.0
info:
...
paths:
  /vessels/{id}/future_positions:
    ...
    get:
      ...
      description: >-
        Returns the estimated route between two ports for a given vessel.
        <Warning> The timestamp of the positions has fixed spacing of one
        minute.</Warning> <Note>This is a paid feature. Please contact
